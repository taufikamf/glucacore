export const IMAGES = {
	...
	pagi: require("../assets/images/pagi.png"),
	siang: require("../assets/images/siang.png"),
	selingan: require("../assets/images/selingan.png"),
	malam: require("../assets/images/malam.png"),
	article1: require("../assets/images/article-1.png"),
	article2: require("../assets/images/article-2.png"),
	article3: require("../assets/images/article-3.png"),
	iconLeft: require("../assets/images/icons/icon-left.png"),
	iconRight: require("../assets/images/icons/icon-right.png"),
	...
	homeHeader: require("../assets/images/home-header.png"),
	calendar: require("../assets/images/icons/calendar.png"),
	regisElipse: require("../assets/images/regis-elipse.png"),
	regisImage: require("../assets/images/regis-image.png"),
