...
const BottomMenu = ({ state, navigation, descriptors }: Props) => {
	...
	const tabWD = tabWidth < SIZES.container ? tabWidth / 3 : SIZES.container / 3;
	...
	const onTabPress = (index: any) => {
		const tabW =
			tabWidth < SIZES.container ? tabWidth / 3 : SIZES.container / 3; // Adjust this according to your tab width
